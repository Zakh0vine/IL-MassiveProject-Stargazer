...
import { Kiri, Tengah, Kanan } from "../../../src/assets/image";
import { Aditya, Anam, Chandra, Diah, Putra, Adi, Cw1, ksng } from "../../../src/assets/image";
import '../../index.css'
      ...
      <section className=''>
        ...
        <div className=' flex md:py-20 py-10 md:px-25 px-10 mx-20 md:flex-row flex-col'>
          <div>
            ...
            <p className='text-xl font-medium text-center sm:leading-[45px] leading-[37px]'> Tim kami terdiri dari berbagai ahli, mulai dari pemimpin yang berpengalaman, pengembang aplikasi yang handal hingga desainer UI/UX yang kreatif. </p>
          </div>
          {/* Tim Muka */}
        </div>
